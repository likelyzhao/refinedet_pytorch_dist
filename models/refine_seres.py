...
class RefineSeResnet(nn.Module):
    def __init__(self, block, num_blocks, size, head7x7=False):
        super(RefineSeResnet, self).__init__()
        self.inplanes = 64
...
def RefineSeResnet18(size, channel_size='48'):
    return RefineSeResnet(SEBasicBlock, [2, 2, 2, 2], size)
